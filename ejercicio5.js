//5.- Mostrar los equipos con más de 25 puntos
...
const ligaSantander = [
  ...
  let showTheBests = (data) =>{
      let theBests = data.filter((team)=>team.points > 25) //Si tuviese que ejectuar más de una línea necesitaria llaves y un return
      console.log(theBests)
  }

  showTheBests(ligaSantander)

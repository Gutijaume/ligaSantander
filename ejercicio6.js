//6.- Mostrar la clasificación del equipo que cuenta con "Vinicius" entre sus mejores jugadors//

//Si por ejemplo me dijese que quiere que muestre la clasificación de los equipos que han ganado la liga debería usar el FILTER
// Con el FIND solo consigue el primer valor que encuentra en el array
...
const ligaSantander = [
    ...
    let viniciusTeamClassification = (data) => {
      let foundPlayer = data.find((team)=> team.bestPlayers.includes("Vinicius"))
      if (foundPlayer){
          console.log(foundPlayer.class)
      } else {
          console.log("Vinicius no está en ningún equipo")
      }
  }

  viniciusTeamClassification(ligaSantander)